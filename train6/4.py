...
# 절대 경로로 디렉토리 설정
input_dir = 'C:\\Code\\computer_vision\\train6\\datasets\\oxford_pets\\images\\images\\'
target_dir = 'C:\\Code\\computer_vision\\train6\\datasets\\oxford_pets\\annotations\\annotations\\trimaps\\'
img_size = (160, 160)
n_class = 3
batch_size = 32
...
cv.imshow('Segmentation label', cv.imread(test_label_paths[0]))

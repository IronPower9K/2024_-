...
def construct_yolo_v3():
    f = open('C:\\Code\\computer_vision\\train6\\coco_names.txt', 'r')
    class_names = [line.strip() for line in f.readlines()]
    
    model = cv.dnn.readNet('C:\\Code\\computer_vision\\train6\\yolov3.weights', 'C:\\Code\\computer_vision\\train6\\yolov3.cfg')
...
img = cv.imread('C:\\Code\\computer_vision\\train6\\soccer.jpg')
